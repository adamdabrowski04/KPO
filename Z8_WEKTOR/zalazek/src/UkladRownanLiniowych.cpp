...
template <class TYP>
UkladRownanLiniowych<TYP>::UkladRownanLiniowych(int ROZMIAR):
    PI(ROZMIAR), Mac_A(ROZMIAR), LU(ROZMIAR), Wek_b(ROZMIAR), Wek_X(ROZMIAR)
{
