...
//}
void RozwiazProblem_int(const int Rozmiar)
{

    Wektor<int>  Wek_Rozw;
    UkladRownanLiniowych<int> A;
    int blad;
    cin>>A;
    cout<<"MaicierzA^T\n"<<A.Mac_A;
