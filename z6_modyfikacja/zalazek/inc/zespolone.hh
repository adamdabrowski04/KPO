 ...
 *LZ1, LZ2 - [We] Argumenty, na których jest wykonywana operacja dodawania.
 ...
 *LZ1, LZ2 - [We] Argumenty, na których jest wykonywana operacja odejmowania.
 *                  Są to obiekty typu Zespolona.
 *
 *\return Wynik operacji jako obiekt typu Zespolona.
 */
 ...
 *LZ - [We] Argument, na którym jest wykonywana odpowiednia operacja.
 *\return Wynik operacji jako obiekt typu Zespolona.
 */
Zespolona operator - (Zespolona LZ);
 ...
 *LZ1, LZ2 - [We] Argumenty, na których jest wykonywana operacja mnożenia.
 *                Są to obiekty typu Zespolona.
 *
 *\return Wynik operacji jako obiekt typu Zespolona.
 */
 ...
 *LZ1, LZ2 - [We] Argumenty, na których jest wykonywana operacja dzielenia.
 *                  Są to obiekty typu Zespolona.
 *
 *\return Wynik operacji jako obiekt typu Zespolona.
 */Zespolona operator / (Zespolona LZ1, Zespolona LZ2 );
 ...
 *LZ1 - [We] Argumenty, na którym jest wykonywana operacja dzielenia.
 *                  Jest to obiekty typu Zespolona.
 *a   - [we] Liczba przez którą dzielimy. Obiekt typu double.
 *
 *\return Wynik operacji jako obiekt typu Zespolona.
 */
 ...
 *LZ1 - [We] Argumenty, na którym jest wykonywana operacja mnożenia.
 *                  Jest to obiekty typu Zespolona.
 *a   - [we] Liczba przez którą mnożymy. Obiekt typu double.
 *
 *\return Wynik operacji jako obiekt typu Zespolona.
 */
Zespolona operator * (Zespolona LZ1, double a );
 ...
 *LZ - [Wy] Referencja do obiektu w którym zostaje zapisana licba zespolona
 *
 ...
 *LZ - [We] Obiekt który zostaje wypisany na podane wyjście;
 *
 ...
 *Lz1, Lz2   -[wy] Wczytane argumenty operacji. Obiekty typu Zespolona.
 * Znak      -[wy] Wczytany znak przeprowadzanej operacji
 *
 *Warunki końcowe:
